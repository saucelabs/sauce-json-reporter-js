...
describe('toJUnitObj', function () {
    ...
    it('should convert to JUnit object', function() {
        ...
        expect((jObj.testsuite[1].properties as any).property[0]._name).toBe('id')
        expect((jObj.testsuite[1].properties as any).property[0]._value).toBe(1234)
        expect((jObj.testsuite[1].properties as any).property[1]._name).toBe('items')
        expect((jObj.testsuite[1].properties as any).property[1]._value).toStrictEqual({"test1": 1, "test2": 2})
